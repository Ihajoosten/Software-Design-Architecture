...
describe("Test method Calculate Price", () => {
  ...
  it("A customer can order 6 premium tickets on Tuesday and should not get a 10% discount", () => {
    ...
    movie.addScreening(movieScreening);
    let ticket = new MovieTicket(movieScreening, true, 1, 15, order.orderType);
    let ticket2 = new MovieTicket(movieScreening, true, 1, 16, order.orderType);
    let ticket3 = new MovieTicket(movieScreening, true, 1, 17, order.orderType);
    let ticket4 = new MovieTicket(movieScreening, true, 1, 18, order.orderType);
    let ticket5 = new MovieTicket(movieScreening, true, 1, 19, order.orderType);
    let ticket6 = new MovieTicket(movieScreening, true, 1, 20, order.orderType);
    order.addSeatReservation(ticket);
    order.addSeatReservation(ticket2);
    order.addSeatReservation(ticket3);
    order.addSeatReservation(ticket4);
